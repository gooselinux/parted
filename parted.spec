...
# All these patches are in upstream git and all before
...
Patch9: parted-2.2-dm_task_run-retcode-rh585158.patch
# Fix mkpartfs (ext2) on partition >2TB
Patch10: parted-2.2-blkoflow-rh585159.patch
# Also recognize recovery partitions with id 27 / on gpt
Patch11: parted-2.2-extend-diag-flag-rh589451.patch
# Recognize scsi disks with a high major as such
Patch12: parted-2.2-hi-major-sd-rh611691.patch
# workaround devicemapper having bad cache consistency between different maps
Patch13: parted-2.1-dm-cache-flush-rh623846.patch
...
%changelog
* Mon Aug 16 2010 Hans de Goede <hdegoede@redhat.com> 2.1-10
- Flush kernel cache of devicemapper devices when opening them (#623846)
  Resolves: #623846

* Tue Jul 20 2010 Hans de Goede <hdegoede@redhat.com> 2.1-9
- Recognize scsi disks with a high major as such (#611691)
  Resolves: #611691

* Thu May  6 2010 Hans de Goede <hdegoede@redhat.com> 2.1-8
- Also recognize recovery partitions with id 27 / on gpt (#589473)
  Resolves: #589473

* Fri Apr 23 2010 Hans de Goede <hdegoede@redhat.com> 2.1-7
- Properly check dm_task_run return value (#585158)
  Resolves: #585158
- Fix mkpartfs (ext2) on partitions >2TB (#585159)
  Resolves: #585159
- Add a flag for detecting diagnostics / recovery partitions

* Tue Apr  6 2010 Hans de Goede <hdegoede@redhat.com> 2.1-6
- Parted should not canonicalize symlinks under /dev/mapper (#577824)
  Resolves: #577824

* Tue Mar 30 2010 Hans de Goede <hdegoede@redhat.com> 2.1-5
- Add descriptions of the patches to the spec file
  Related: rhbz#555835

* Thu Feb 18 2010 Hans de Goede <hdegoede@redhat.com> 2.1-4
- Copy needs_clobber value in ped_disk_duplicate() (#566181)
  Resolves: #566181

* Wed Feb 10 2010 Hans de Goede <hdegoede@redhat.com> 2.1-3
...
* Sun Jan 31 2010 Hans de Goede <hdegoede@redhat.com> 2.1-2
...
- This fixes the usage of disks with 4k logical sectors (#523954)
  Resolves: #523954
...
* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 1.9.0-23.1
- Rebuilt for RHEL 6
